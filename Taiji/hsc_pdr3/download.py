...
def hsc_cutout_tool(rerun_field,
    ...
    if system_use == 'linux':
        process = subprocess.Popen([
            "python /home/dewang/Taiji/Taiji/hsc_pdr3/downloadCutout/downloadCutout.py --rerun='{0}' --type='{1}' --mask=True --variance=True --ra={2} --dec={3} --sw={4}arcsec --sh={5}arcsec --name='{6}' --user='dwxu' --max-connections=20"
